...
if($decode){
    ...
    {
        $ft = new TProveedores();
        $response = $ft->updateProveedor($decode->proveedor->id,$decode->proveedor->ruc, $decode->proveedor->nombres, $decode->proveedor->apellidos, $decode->proveedor->direccion, $decode->proveedor->telefono);     
    }    
}
else
{
